...
class NeuralIndexBuilder:
    ...
    def __init__(
        self,
        embed_dim: int = 512,
        dimension: int | None = None,  # Alias for embed_dim.
    ...
    def build_index(
        ...
        assert self.embed_dim == D, f"Expected dimension {self.embed_dim}, got {D}"
        ...
        if index_type_upper == "HNSW":
            ...
            raise ValueError(
                f"Unknown index type: {self.index_type}. Supported: HNSW, IVF-PQ, Flat"
            )
