...
class PathPlanner:
    ...
    def plan_path(
        ...
        hazards = [d for d in detections if d.get("urgency", 0) >= 2 and d.get("distance", 2) <= 1]
    ...
    def _calculate_direction_safety(self, obstacles: list[dict], direction: str) -> float:
    ...
    def suggest_navigation_guidance(self, detections: list[dict], verbosity: str = "normal") -> str:
