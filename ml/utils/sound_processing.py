...
class SoundProcessor:
    ...
    def refine_sound_classification(
        ...
        raw_predictions: torch.Tensor | None = None,
        ...
        if raw_predictions is not None:
            ...
            for class_idx, sound_class in enumerate(SoundClass):
                ...
                if confidence > confidence_threshold:
                    detections.append(
                        {"class": sound_class, "confidence": confidence, "class_idx": class_idx}
                    )
        else:
    ...
    def detect_direction(
        self,
        audio_features: torch.Tensor,
        stereo_channels: tuple[torch.Tensor, torch.Tensor] | None = None,
    ) -> SoundDirection:
    ...
    def prioritize_sounds(
        self, sound_detections: list[dict], visual_context: dict | None = None
    ) -> list[dict]:
    ...
    def get_sound_description(self, sound_detection: dict, include_direction: bool = True) -> str:
