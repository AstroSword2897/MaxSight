...
TOP7 = ["amblyopia", "amd", "color_blindness", "cvi", "glaucoma", "retinitis_pigmentosa", "strabismus"]
...
def main():
    ...
    for c in TOP7:
        ...
        has_coreml = Path(coreml_path).exists() if coreml_path else (cond_dir / f"{c}.mlpackage").exists()
