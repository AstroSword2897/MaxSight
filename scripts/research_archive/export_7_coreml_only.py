...
def main():
    ...
    p.add_argument("--checkpoints-base", type=Path, default=None, help="Base dir with checkpoints_<cond>/best_model.pt")
    p.add_argument("--output-dir", type=Path, default=REPO / "exports" / "top7", help="Output root")
    p.add_argument("--quiet", action="store_true")
    args = p.parse_args()

    base = args.checkpoints_base or Path(os.environ.get("CHECKPOINTS_BASE", REPO / "checkpoints")).resolve()
