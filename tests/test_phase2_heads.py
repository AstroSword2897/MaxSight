...
class TestOCRHead:
    ...
    def test_ocr_head_forward(self):
        ...
        ocr_head = TransformerOCRHead(input_dim=256, vocab_size=100, max_text_length=50)
        ocr_head.eval()
...
class TestSceneDescriptionHead:
    ...
    def test_scene_desc_forward(self):
        ...
        desc_head = SceneDescriptionHead(
            global_dim=512, region_dim=256, ocr_dim=256, vocab_size=5000, max_length=100
        )
        desc_head.eval()
...
class TestPersonalizationHead:
    ...
    def test_personalization_forward(self):
        ...
        personal_head = PersonalizationHead(
            input_dim=512, num_features=10, num_alert_types=5, embed_dim=128
        )
        personal_head.eval()
...
class TestPredictiveAlertHead:
    ...
    def test_predictive_alert_forward(self):
        ...
        alert_head = PredictiveAlertHead(input_dim=512, motion_dim=256, num_hazard_types=10)
        alert_head.eval()
