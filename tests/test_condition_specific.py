...
def test_condition_robustness():
    ...
    conditions = [
        ...
        (
            ...
            "myopia",
            lambda img: apply_refractive_error_blur(img, sigma=4.0),
        ),
        (
            "Hyperopia (Farsightedness)",
            "hyperopia",
            lambda img: apply_refractive_error_blur(img, sigma=3.0),
        ),
        ...
        (
            ...
            lambda img: apply_cataract_contrast(img, contrast_factor=0.6),
        ),  # Similar to cataracts.
        (
            "Retinitis Pigmentosa (Night Blindness)",
            "retinitis_pigmentosa",
            lambda img: apply_low_light(img, brightness_factor=0.3),
        ),
        # Color vision (9)
        (
            "Color Blindness (Red-Green)",
            "color_blindness",
            lambda img: apply_color_shift(img, shift_type="red_green"),
        ),
        # Brain-based (10-12)
        (
            "CVI (Cortical Visual Impairment)",
            "cvi",
            lambda img: apply_cataract_contrast(img, contrast_factor=0.7),
        ),  # Simplified.
        (
            "Amblyopia (Lazy Eye)",
            "amblyopia",
            lambda img: apply_refractive_error_blur(img, sigma=2.0),
        ),  # Mild blur.
        (
            "Strabismus (Crossed Eyes)",
            "strabismus",
            lambda img: apply_refractive_error_blur(img, sigma=2.5),
        ),  # Moderate blur.
    ]
    ...
    print("Target: All conditions maintain <10-15% degradation")
