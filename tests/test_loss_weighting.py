...
def test_temporal_weight_schedule_warmup() -> None:
    sched = TemporalWeightSchedule(start_epoch=0, warmup_epochs=4, start_weight=0.1, target_weight=0.5)
...
def test_build_temporal_weight_updates() -> None:
    sched = TemporalWeightSchedule(start_epoch=0, warmup_epochs=2, start_weight=0.2, target_weight=1.0)
