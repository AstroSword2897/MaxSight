...
class TestAttentionFusion:
    ...
    def test_attention_fusion_forward(self):
        ...
        fusion = AttentionFusion(
            embedding_dims={"global": 256, "region": 128, "patch": 64}, fused_dim=256
        )
        fusion.eval()
...
class TestFAISSIndexing:
    ...
    def test_index_builder_initialization(self):
        ...
        builder = NeuralIndexBuilder(embed_dim=256, index_type="hnsw", metric="cosine")
...
class TestTwoStageRetrieval:
    ...
    def test_stage2_reranking(self):
        ...
        reranker = Stage2Reranker(
            embedding_dims={"global": 256, "region": 128, "patch": 64}, hidden_dim=256
        )
        reranker.eval()
        ...
        reranked_scores, reranked_indices = reranker(query_vectors, candidates)
