...
class TestEnhancedAudioEncoder:
    ...
    def test_audio_encoder_initialization(self):
        ...
        encoder = EnhancedAudioEncoder(input_dim=128, embed_dim=256, num_heads=8)
    ...
    def test_audio_encoder_forward(self):
        ...
        encoder = EnhancedAudioEncoder(input_dim=128, embed_dim=256)
        encoder.eval()
...
class TestSpatialSoundMapping:
    ...
    def test_spatial_sound_forward(self):
        ...
        mapping = SpatialSoundMapping(audio_dim=256, attention_size=(14, 14), num_directions=4)
        mapping.eval()
...
class TestHapticEmbedding:
    ...
    def test_haptic_forward(self):
        ...
        haptic = HapticEmbedding(haptic_dim=64, embed_dim=128, num_patterns=10)
        haptic.eval()
...
class TestHapticVisualAttention:
    ...
    def test_haptic_visual_forward(self):
        ...
        attn = HapticVisualAttention(haptic_embed_dim=128, visual_embed_dim=256, attention_dim=128)
        attn.eval()
...
class TestMultimodalFusion:
    ...
    def test_multimodal_forward(self):
        ...
        fusion = MultimodalFusion(
            vision_dim=512, audio_dim=256, depth_dim=128, haptic_dim=64, embed_dim=512
        )
        fusion.eval()
    ...
    def test_multimodal_without_optional(self):
        ...
        fusion = MultimodalFusion(
            vision_dim=512, audio_dim=256, depth_dim=0, haptic_dim=0, embed_dim=512
        )
        fusion.eval()
